                   ...
                   <div className="flex justify-between gap-2 mt-2">
                     {[0, 1, 2, 3].map((index) => (
                       <input
                         ...
                         className="w-[3.1rem] h-[3.5rem] sm:w-[3.4rem] sm:h-[3.8rem] text-center text-xl font-semibold bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 focus:border-[#8B9543] focus:ring-2 focus:ring-[#8B9543]/20 rounded-xl outline-none transition-all text-gray-900 dark:text-white"
                         placeholder="-"
                       />
                     ))}
                   </div>
