...
const SubCategoryPage = lazy(() => import("@food/pages/admin/categories/SubCategoryPage"));
      ...
      <Routes>
        ...
        >
          ...
          <Route path="food/*">
            ...
            <Route path="categories/subcategory" element={<SubCategoryPage />} />
            <Route path="categories/subcategory/add" element={<SubCategoryPage />} />
