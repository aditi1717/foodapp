...
const Subscriptions = lazy(() => import("@food/pages/user/profile/Subscriptions"))
    ...
    <Suspense fallback={<Loader />}>
      <Routes>
        <Route element={<UserLayout />}>
          ...
          />
          <Route path="user/profile" element={<Navigate to="/food/profile" replace />} />
          <Route path="user/profile/subscriptions" element={<Navigate to="/food/profile/subscriptions" replace />} />
          <Route path="user/profile/my-subscriptions" element={<Navigate to="/food/profile/my-subscriptions" replace />} />
          <Route path="user/profile/edit" element={<Navigate to="/food/profile/edit" replace />} />
          <Route path="user/profile/payments" element={<Navigate to="/food/profile/payments" replace />} />
          <Route path="user/profile/payments/new" element={<Navigate to="/food/profile/payments/new" replace />} />
          <Route path="user/profile/coupons" element={<Navigate to="/food/profile/coupons" replace />} />
          <Route path="user/profile/support" element={<Navigate to="/food/profile/support" replace />} />
          <Route path="user/profile/refer-earn" element={<Navigate to="/food/profile/refer-earn" replace />} />
          <Route path="user/profile/about" element={<Navigate to="/food/profile/about" replace />} />
          <Route
          ...
          <Route path="auth/login" element={<AuthLoginRedirect />} />
          <Route path="auth/sign-in" element={<AuthLoginRedirect />} />
