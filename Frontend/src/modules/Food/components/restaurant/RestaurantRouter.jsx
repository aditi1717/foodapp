  ...
  return (
    <Suspense fallback={<Loader />}>
      <Routes>
        ...
        <Route path="menu-categories" element={<Navigate to="/food/restaurant/explore" replace />} />
        <Route path="menu-categories/new" element={<Navigate to="/food/restaurant/explore" replace />} />
        <Route path="menu-categories/:id/edit" element={<Navigate to="/food/restaurant/explore" replace />} />
