...
const RestaurantSubscriptions = lazy(() => import("@food/pages/restaurant/Subscriptions"))
const RestaurantMySubscription = lazy(() => import("@food/pages/restaurant/MySubscription"))
...
const DeliveryPartnersPage = lazy(() => import("@food/pages/restaurant/DeliveryPartnersPage"))
  ...
  return (
    <Suspense fallback={<Loader />}>
      <Routes>
        ...
        <Route element={<ProtectedRoute requiredRole="restaurant" loginPath="/food/restaurant/login"><RestaurantSubscriptions /></ProtectedRoute>} path="subscriptions" />
        <Route element={<ProtectedRoute requiredRole="restaurant" loginPath="/food/restaurant/login"><RestaurantMySubscription /></ProtectedRoute>} path="my-subscription" />
        <Route element={<ProtectedRoute requiredRole="restaurant" loginPath="/food/restaurant/login"><RestaurantMySubscription /></ProtectedRoute>} path="my-subscriptions" />
        <Route path="business-plan" element={<Navigate to="/food/restaurant/subscriptions" replace />} />
        ...
        <Route element={<ProtectedRoute requiredRole="restaurant" loginPath="/food/restaurant/login"><DeliveryPartnersPage /></ProtectedRoute>} path="delivery-partners" />
      </Routes>
    </Suspense>
  )
}
