  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      if (order?.fulfillmentType === 'takeaway') {
        addText("Takeaway (Self Pickup)", margin, { size: 10, style: "bold", color: [37, 99, 235] })
      } else if (customer.addressLines.length) {
              ...
              <div className="invoice-details grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mt-4 sm:mt-6">
                <div>
                  ...
                  {order?.fulfillmentType === 'takeaway' ? (
                    <p className="text-xs sm:text-sm font-medium text-blue-600 mt-1">Takeaway (Self Pickup)</p>
