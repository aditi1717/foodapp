...
export default function NewRefundRequests() {
  ...
  const {
    ...
    orders,
    "New Refund Requests",
    ["orderId", "customerName", "shop", "customerPhone"]
  )
            ...
            <table className="w-full min-w-full">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-[10px] font-bold text-slate-700 uppercase">Shop</th>
                ...
                {filteredData.length === 0 ? (
                  ...
                  filteredData.map((order, index) => (
                    <tr key={order.orderId} className="hover:bg-slate-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm font-medium text-slate-700">{order.shop}</span>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm text-red-600 max-w-xs">
                          {order.cancellationReason || "Rejected by shop"}
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
