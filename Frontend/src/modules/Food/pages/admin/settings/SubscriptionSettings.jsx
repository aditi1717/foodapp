      ...
      <div className="space-y-4">
            ...
            <div className="w-full md:w-48">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full pl-3 pr-8 py-2 text-xs border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 appearance-none"
                >
                  <option>Day</option>
                  <option>Month</option>
                </select>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-slate-200 mb-4">
          <div className="px-5 py-4 border-b border-slate-100">
            ...
            <p className="text-xs text-slate-500 mt-1 max-w-xl">
              Setup the amount after which if any shop change / migrate
