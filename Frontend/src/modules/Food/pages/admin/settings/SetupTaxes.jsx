          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 px-4 py-3 border-b border-slate-100">
            <div>
              <h2 className="text-sm font-semibold text-slate-900">
                Allow Tax Calculation For Shop ?
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-slate-700">
              <label className="flex gap-3 rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 cursor-pointer">
                <input
                  ...
                  className="mt-1 w-3.5 h-3.5 text-brand-600"
                />
                <div>
              ...
              <label className="flex gap-3 rounded-lg border border-brand-500 bg-brand-50 px-4 py-3 cursor-pointer">
                <input
                  type="radio"
                  name="price-mode"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
                >
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full pl-3 pr-8 py-2 border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
                  >
