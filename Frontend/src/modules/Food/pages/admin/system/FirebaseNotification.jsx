...
const notificationMessages = [
  ...
  },
  {
    ...
    label: "Shop handover message",
    defaultText: "Your order {orderId} has been handed over to shop {restaurantName}",
    enabled: true
  },
  {
    id: 5,
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 text-xs border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 resize-none font-mono"
                />
              </div>
