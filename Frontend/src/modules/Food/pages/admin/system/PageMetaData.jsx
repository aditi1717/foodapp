                      ...
                      {visibleColumns.actions && (
                        <td className="px-3 py-2.5 whitespace-nowrap text-center">
                          <button
                            ...
                            className="px-3 py-1.5 text-xs font-medium bg-brand-600 text-white rounded-lg hover:bg-brand-700 transition-colors flex items-center gap-1 mx-auto"
                          >
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-slate-200">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium rounded-lg bg-brand-600 text-white hover:bg-brand-700 transition-all"
              >
                Save Changes
              </button>
            </div>
