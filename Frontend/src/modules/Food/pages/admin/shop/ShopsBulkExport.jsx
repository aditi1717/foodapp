    ...
    <div className="p-4 lg:p-6 bg-slate-50 min-h-screen">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Export Shops</h1>
            <p className="text-sm text-slate-500 mt-1">
              Export shop data in bulk using filters
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-bold text-slate-900">Export All Shop Data</h2>
        </div>
        <div className="ml-14">
          <div className="p-4 bg-slate-50 rounded-lg border border-slate-200">
            <div className="flex items-center gap-2 text-sm text-slate-600">
              <FileSpreadsheet className="w-4 h-4 text-emerald-600" />
              <span>All shop data will be exported in Excel (.xlsx) format</span>
            </div>
          </div>
        </div>
      </div>
