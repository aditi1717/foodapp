        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Import shops in bulk using Excel files
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-start gap-6">
          <div className="flex-1">
            ...
            <div className="space-y-2 text-sm text-slate-600 ml-14 mb-6">
              ...
              <p>• Shop owner information must be complete and accurate</p>
        ...
        <div className="flex items-start gap-6">
          <div className="flex-1">
            ...
            <div className="space-y-2 text-sm text-slate-600 ml-14">
              ...
              <p>• You can upload your shop images in shop folder from gallery and copy image's path.</p>
            </div>
          </div>
