                ...
                {filteredTransactions.length === 0 ? (
                  ...
                  filteredTransactions.map((transaction) => (
                    <tr key={transaction.sl} className="hover:bg-slate-50 transition-colors">
                      ...
                      {visibleColumns.collectedFrom && (
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="text-sm text-brand-600 font-medium cursor-pointer hover:underline">
        ...
        <DialogContent className="max-w-md bg-white p-0 opacity-0 data-[state=open]:opacity-100 data-[state=closed]:opacity-0 transition-opacity duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0 data-[state=open]:scale-100 data-[state=closed]:scale-100">
          ...
          <DialogFooterComponent className="px-6 pb-6">
            <button
              ...
              className="px-4 py-2 text-sm font-medium rounded-lg bg-brand-600 text-white hover:bg-brand-700 transition-all shadow-md"
            >
              Close
            </button>
          </DialogFooterComponent>
