                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full px-4 py-2.5 pr-10 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 text-sm ${
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        {profilePreview ? (
                          ...
                          <div
                            ...
                            className={`border-2 border-dashed rounded-lg p-6 text-center hover:border-brand-500 transition-colors cursor-pointer ${
                              formErrors.profileImage ? "border-red-500" : "border-slate-300"
                            }`}
                          >
                            <Upload className="w-8 h-8 text-slate-400 mx-auto mb-2" />
                            <p className="text-sm font-medium text-brand-600 mb-1">Click to Upload Profile Image</p>
                      ...
                      <div>
                        ...
                        {coverPreview ? (
                          ...
                          >
                            <Upload className="w-8 h-8 text-slate-400 mx-auto mb-2" />
                            <p className="text-sm font-medium text-brand-600 mb-1">Click to Upload Cover Image</p>
                            <p className="text-xs text-slate-500">Supports: PNG, JPG, JPEG, WEBP Maximum 2 MB</p>
                          </div>
                        )}
                  ...
                  <div className="flex items-center justify-end gap-4">
                    ...
                    <button
                      type="submit"
                      disabled={isSubmitting}
                      className="px-6 py-2.5 text-sm font-medium rounded-lg bg-brand-600 text-white hover:bg-brand-700 transition-all shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                      {isSubmitting ? (
                        <>
