          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-4 py-2.5 text-sm font-medium rounded-lg bg-[#8B9543] text-white hover:bg-[#6F7735] disabled:bg-brand-300 disabled:cursor-not-allowed flex items-center gap-2 transition-all"
                        ...
                        {visibleColumns.deliveryman && (
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex flex-col">
                              <span className="text-sm font-medium text-[#8B9543]">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl border border-slate-200">
                  <div className="p-2 bg-brand-100 rounded-lg">
                    <User className="w-5 h-5 text-[#8B9543]" />
                  </div>
