...
export default function SearchingDeliveryMan() {
  ...
  const {
    ...
    ["id", "customerName", "shop", "customerPhone"]
  )
    ...
    <div className="p-4 lg:p-6 bg-slate-50 min-h-screen">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center rounded-full bg-brand-50 px-3 py-1 text-xs font-medium text-brand-600 border border-brand-100">
