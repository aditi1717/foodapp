                        ...
                        {expandedSections.taxDeductions && (
                          ...
                          >
                            <div className="px-4 pb-3 space-y-2 border-t border-dashed border-gray-200">
                              ...
                              <div className="flex items-center justify-between py-2 border-t border-dashed border-gray-200">
                                <div className="flex items-center gap-1.5">
                                  <span className="text-sm text-gray-700">GST paid by FreshCut Local on behalf of the shop u/s 9(5) of GST</span>
                                  <Info className="w-3.5 h-3.5 text-gray-400" />
                                </div>
                                <span className="text-sm font-medium text-gray-900">
                                  ₹{(settlementData.taxDeductions?.gstPaidByIggymet || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                </span>
                              </div>
                            </div>
                          </motion.div>
