        ...
        <div className="px-4 py-6 space-y-6">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <button
              ...
              className="text-brand-600 text-sm font-normal hover:text-brand-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Edit photo
            </button>
            <input
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  disabled={loading || saving}
                />
                <Edit className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-brand-600" />
              </div>
            </div>
          ...
          <div className="pt-4">
            ...
            >
              ...
              <span className="text-sm font-normal">Delete your FreshCut Local account</span>
            </button>
          </div>
        </div>
          ...
          <DialogContent className="sm:max-w-md p-4 w-[90%]">
            <DialogHeader className="text-center">
              ...
              <DialogTitle className="text-base font-semibold text-gray-900 text-center">
                You are about to delete your FreshCut Local account
              </DialogTitle>
