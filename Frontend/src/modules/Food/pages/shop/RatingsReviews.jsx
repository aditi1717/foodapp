        ...
        <div className="px-4 py-6 pb-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 border-2 border-brand-600 bg-white rounded-lg py-3 px-4 hover:bg-brand-50 transition-colors"
            >
              <ThumbsUp className="w-5 h-5 text-brand-600" />
              <span className="text-brand-600 text-sm font-semibold">Yes, thank you</span>
            </button>
            <button
      ...
      >
        <div className="text-center py-6">
          ...
          <button
            ...
            className="w-full bg-brand-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-brand-700 transition-colors"
          >
            Contact Support
          </button>
        </div>
