                              ...
                              <div className="flex flex-1 items-center gap-3 min-w-0">
                                ...
                                <div className="min-w-0">
                                  <div className="flex items-center gap-2 flex-wrap">
                                    <p className="text-sm font-semibold text-slate-900 break-words whitespace-normal">
                                      {item.name}
                                    </p>
                  ...
                  <label className="flex items-center justify-between py-4 cursor-pointer">
                    <div className="flex flex-col gap-1 flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Item won't be visible to customers on FreshCut Local app till you mark it back in stock
                      </p>
                    </div>
                  </label>
                </div>
