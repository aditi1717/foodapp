export const adminSidebarMenu = [
    ...
    items: [
      {
        ...
        path: "/admin/food/subscription/resto/packages",
        icon: "Package",
      },
      {
        type: "link",
        label: "Subscriber List",
        path: "/admin/food/subscription/resto/subscribers",
        icon: "Users",
      },
      {
        type: "link",
        label: "Subscription Report",
        path: "/admin/food/subscription/resto/report",
        icon: "FileText",
      },
    ],
  },
  {
    ...
    items: [
      ...
      { type: "link", label: "Dispatch Settings", path: "/admin/food/settings", icon: "Settings" },
      ...
      { type: "link", label: "Delivery Support Tickets", path: "/admin/food/delivery-support-tickets", icon: "MessageSquare" },
      {
        ...
        subItems: [
          ...
          { label: "Delivery Withdrawals", path: "/admin/food/delivery-partners/withdrawals" },
        ],
      },
    ],
  },
