 ...
 * - Set routeDestination to shop location
      ...
      <div className={`absolute ${isFullScreen ? 'left-6 top-6' : 'left-3 top-3'} flex flex-col gap-2 z-10`}>
        ...
        {routeInfo && isFullScreen && (
          ...
          >
            ...
            {destinationName && (
              <div className="text-xs text-brand-600 mt-1 font-medium truncate">
                to {destinationName}
              </div>
            )}
          </motion.div>
