...
import { ProfileWalletV2 } from './pages/profile/ProfileWalletV2';
...
import ExclusivityRequestsPage from './pages/profile/ExclusivityRequestsPage';
  ...
  return (
    <Suspense fallback={<Loader />}>
      <Routes>
        ...
        <Route path="/profile/wallet" element={<ProtectedRoute><ProfileWalletV2 /></ProtectedRoute>} />
        <Route path="/profile/exclusivity-requests" element={<ProtectedRoute><ExclusivityRequestsPage /></ProtectedRoute>} />
