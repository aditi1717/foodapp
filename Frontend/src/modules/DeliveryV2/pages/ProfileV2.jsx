    ...
    const initData = async () => {
      try {
        ...
        if (profileRes?.data?.success && profileRes?.data?.data?.profile) {
          const fetchedProfile = profileRes.data.data.profile
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-poppins pb-28">
      ...
      <div className="px-4 pt-5 space-y-4">
        ...
        <div className="bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden">
            ...
            <div 
              onClick={() => navigate("/food/delivery/profile/wallet")}
              className="px-4 py-3.5 border-b border-gray-50 flex items-center justify-between cursor-pointer active:bg-gray-50 transition-colors"
            >
              <div className="flex items-center gap-3">
                 <Wallet className="w-4 h-4" style={{ color: BRAND_THEME.colors.brand.primary }} />
                 <span className="text-sm font-medium text-gray-800">Pocket (Wallet Options)</span>
              </div>
            ...
            <div 
              onClick={() => navigate("/food/delivery/profile/exclusivity-requests")}
              className="px-4 py-3.5 border-b border-gray-50 flex items-center justify-between cursor-pointer active:bg-gray-50 transition-colors"
            >
              <div className="flex items-center gap-3">
