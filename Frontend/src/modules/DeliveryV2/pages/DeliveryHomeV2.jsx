      ...
      <div className="w-full rounded-2xl border border-slate-200 bg-white px-3 py-2.5 shadow-[0_8px_20px_rgba(15,23,42,0.045)]">
        ...
        <div className="mt-2.5 grid grid-cols-2 gap-1.5">
          <button
            ...
            disabled={isBusy}
            className="rounded-xl bg-[#8B9543] px-3 py-2 text-[11px] font-bold text-white disabled:opacity-60"
          >
      ...
      <div className={`flex-1 relative overflow-y-auto ${currentTab === 'feed' ? 'pt-[76px]' : currentTab === 'history' ? 'pt-0' : 'pt-[64px]'}`}>
        {currentTab === 'feed' ? (
          <div className="absolute inset-0 top-[-76px]">
            ...
            {isSimMode && (
              <div className="absolute top-[180px] left-4 right-4 z-[100] bg-[#8B9543]/70 backdrop-blur-md rounded-xl p-4 border border-white/20 flex items-center justify-between shadow-2xl">
