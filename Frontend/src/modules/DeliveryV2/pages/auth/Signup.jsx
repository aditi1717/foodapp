    ...
    <div className="h-screen w-full flex bg-white overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 flex items-center text-white pointer-events-none">
          <div
            className="bg-[#8B9543] sm:bg-[#6F7735] rounded-r-full py-10 xl:py-20 pl-10 xl:pl-14 pr-10 xl:pr-20 max-w-[70%] shadow-xl backdrop-blur-[1px]"
        ...
        >
          ...
          >
            ...
            <Button
              ...
              style={{ background: "linear-gradient(135deg, #8B9543 0%, #6F7735 100%)" }}
              disabled={isLoading}
            >
              {isLoading ? (
                <>
