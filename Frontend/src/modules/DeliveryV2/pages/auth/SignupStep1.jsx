        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              inputMode="text"
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B9543] ${errors.name ? "border-red-500" : "border-gray-300"
                }`}
          ...
          <div>
            ...
            <input
              ...
              autoComplete="email"
              inputMode="email"
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B9543] ${errors.email ? "border-red-500" : "border-gray-300"
                }`}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={3}
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B9543] ${errors.address ? "border-red-500" : "border-gray-300"
                }`}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                value={formData.city}
                onChange={handleChange}
                className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B9543] ${errors.city ? "border-red-500" : "border-gray-300"
                  }`}
                placeholder="City"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B9543] ${errors.state ? "border-red-500" : "border-gray-300"
                  }`}
                placeholder="State"
              />
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B9543]"
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              maxLength={10}
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B9543] ${errors.vehicleNumber ? "border-red-500" : "border-gray-300"
                }`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              maxLength={15}
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B9543] uppercase ${errors.drivingLicenseNumber ? "border-red-500" : "border-gray-300"
                }`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              maxLength={10}
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B9543] uppercase ${errors.panNumber ? "border-red-500" : "border-gray-300"
                }`}
          ...
          <div>
            ...
            <input
              ...
              maxLength={12}
              inputMode="numeric"
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B9543] ${errors.aadharNumber ? "border-red-500" : "border-gray-300"
                }`}
          ...
          <button
            ...
            style={
              isSubmitting
                ? undefined
                : { background: "linear-gradient(135deg, #8B9543 0%, #6F7735 100%)", boxShadow: "0 12px 28px -18px #6F7735" }
            }
          >
