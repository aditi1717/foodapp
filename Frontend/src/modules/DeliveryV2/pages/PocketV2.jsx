      ...
      <div className="p-4 space-y-4">
        ...
        <div className="rounded-2xl border border-emerald-100 bg-emerald-50/40 p-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <InfoCard 
              label="Remaining COD Order Limit" 
              value={formatCurrency(Math.max(0, walletState.pocketBalance - walletState.cashInHand))} 
              className="col-span-2 border-emerald-200 bg-emerald-100/30"
            />
          </div>
        </div>
