...
const pricingSchema = new mongoose.Schema(
    {
        ...
        subscriptionBenefit: {
            ...
            maxFreeDeliveries: { type: Number, default: null, min: 0 },
            deliveriesUsedAtCalculation: { type: Number, default: 0, min: 0 },
            savedDeliveryFee: { type: Number, default: 0, min: 0 },
            usageConsumed: { type: Boolean, default: false },
        },
...
const orderSchema = new mongoose.Schema(
    {
        ...
        deliveryAddress: {
            ...
            required() {
                return this.orderType === 'food' && this.fulfillmentType !== 'takeaway';
            }
        },
        pricing: {
            type: pricingSchema,
