...
router.post('/support-tickets/:id/messages', authMiddleware, requireRoles('DELIVERY_PARTNER'), addSupportTicketMessageController);
router.patch('/support-tickets/:id/status', authMiddleware, requireRoles('DELIVERY_PARTNER'), updateSupportTicketStatusController);
...
router.post('/store/orders/bulk', authMiddleware, requireRoles('DELIVERY_PARTNER'), createBulkStoreOrderDelivery);
router.post('/store/orders/verify', authMiddleware, requireRoles('DELIVERY_PARTNER'), verifyStoreOrderDelivery);
router.post('/store/orders/bulk/verify', authMiddleware, requireRoles('DELIVERY_PARTNER'), verifyBulkStoreOrderDelivery);
...
// Exclusivity requests management
router.get('/exclusivity-requests', authMiddleware, requireRoles('DELIVERY_PARTNER'), listIncomingRequestsController);
router.post('/exclusivity-requests/:requestId/accept', authMiddleware, requireRoles('DELIVERY_PARTNER'), acceptExclusivityRequestController);
