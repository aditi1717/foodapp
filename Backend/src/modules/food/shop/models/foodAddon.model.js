...
const foodAddonSchema = new mongoose.Schema(
    {
        ...
        // Draft is what shop is editing and what admin approves/rejects.
        ...
        // Operational toggle controlled by shop; user app filters on this.
...
foodAddonSchema.index({ shopId: 1, isDeleted: 1, createdAt: -1 });
foodAddonSchema.index({ approvalStatus: 1, isDeleted: 1, requestedAt: -1 });
foodAddonSchema.index({ shopId: 1, approvalStatus: 1, isDeleted: 1, requestedAt: -1 });
