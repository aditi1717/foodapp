...
export const ADMIN_PERMISSION_PATHS = {
    ...
    SHOPS: "/admin/food/shops",
    SHOP_JOINING_REQUEST: "/admin/food/shops/joining-request",
    SHOP_COMMISSION: "/admin/food/shops/commission",
    SHOP_REVIEWS: "/admin/food/shops/reviews",
    SHOP_COMPLAINTS: "/admin/food/shops/complaints",
    ...
    SHOP_REPORT: "/admin/food/shop-report",
    SHOP_WITHDRAWS: "/admin/food/shop-withdraws",
...
const API_PERMISSION_MAP = [
    ...
    { methods: ["GET"], pattern: /^\/shops(\/|$)/, permission: ADMIN_PERMISSION_PATHS.SHOPS },
    { methods: ["POST"], pattern: /^\/shops$/, permission: ADMIN_PERMISSION_PATHS.SHOPS },
    { methods: ["PATCH"], pattern: /^\/shops\/[^/]+(\/|$)/, permission: ADMIN_PERMISSION_PATHS.SHOPS },
    ...
    { methods: ["GET"], pattern: /^\/shop-report$/, permission: ADMIN_PERMISSION_PATHS.SHOP_REPORT },
    { methods: ["GET"], pattern: /^\/shop-withdraws$/, permission: ADMIN_PERMISSION_PATHS.SHOP_WITHDRAWS },
