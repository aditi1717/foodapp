...
export const config = {
    ...
    firebaseWebAuthDomain: process.env.FIREBASE_AUTH_DOMAIN || process.env.VITE_FIREBASE_AUTH_DOMAIN,
    firebaseWebStorageBucket: process.env.FIREBASE_STORAGE_BUCKET || process.env.VITE_FIREBASE_STORAGE_BUCKET,
    firebaseWebMessagingSenderId:
        process.env.FIREBASE_MESSAGING_SENDER_ID || process.env.VITE_FIREBASE_MESSAGING_SENDER_ID,
    firebaseWebAppId: process.env.FIREBASE_APP_ID || process.env.VITE_FIREBASE_APP_ID,
    firebaseWebMeasurementId: process.env.FIREBASE_MEASUREMENT_ID || process.env.VITE_FIREBASE_MEASUREMENT_ID,
    firebaseWebVapidKey: process.env.FIREBASE_VAPID_KEY || process.env.VITE_FIREBASE_VAPID_KEY,
